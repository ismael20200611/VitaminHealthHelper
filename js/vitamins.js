const vitaminData = {
  vitaminA: {
    ...
    workouts: ["Outdoor walking", "Eye relaxation exercises", "Face yoga for vision"],
  ...
  vitaminB1: {
    ...
    foods: ["Whole Grains 🌾", "Sunflower Seeds 🌻", "Beans 🫘", "Green Peas", "Pork 🐖", "Flaxseeds"],
  ...
  vitaminB2: {
    ...
    workouts: ["Light aerobic exercises", "Stretching", "Yoga flows"],
  ...
  vitaminB5: {
    ...
    workouts: ["Resistance training", "Stretch-based exercises", "Strength yoga"],
  ...
  vitaminB9: {
    ...
    workouts: ["Gentle stretching", "Yoga", "Pilates"],
  ...
  vitaminD: {
    ...
    workouts: ["Outdoor jogging", "Sun yoga", "Morning stretching"],
